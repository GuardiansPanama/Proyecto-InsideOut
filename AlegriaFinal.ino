...
void setup() {
  ...
  digitalWrite(ledPin, LOW); // Asegurar que el LED empiece apagado
}
...
void loop() {
  if(Serial.available() > 0) { 
    ...
    // Encender LED cuando se recibe 'F' o 'f'
    if(mensaje == 'F' || mensaje == 'f') {
...
// Las funciones de movimiento y servos permanecen iguales
void atras() {
  digitalWrite(dir1, 0);
  digitalWrite(dir2, 0);
