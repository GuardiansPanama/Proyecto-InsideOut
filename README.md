...
NUESTRO PROYECTO SE BASA EN EL USO DE LA UN SISTEMA DE CONTROL QUE UTILIZA INTELIGENCIA ARTIFICIAL PARA EL RECONOCIMIENTO DE GESTOS DE EMOCIONES (ALEGRIA, TRISTEZA, IRA, DISGUSTO),QUE CONTROLA LOS ROBOTS Y EL SHOW .MEDIANTE EL PROGRAMA OPENCV SE PROCESA EL VIDEO EN VIVO, CON GOOGLE MEDIA PIPE IDENTIFICAMOS ROSTROS, UTILIZAMOS EL PROGRAMA DEEPFACE, UN PROGRAMA LIGERO EN PHYTON CON LA CAPACIDAD DE RECONOCER GESTOS, AL RECONOCER LA EMOCION ENVIA UN COMANDO POR MEDIO DEL PROGRAMA PYSERIAL A UN CONTROLADOR ARDUINO Y ESTE ENVIA INSTRUCCIONES MEDIANTE UN SISTEMA XBEE  A LOS DIFERENTES ROBOTS PARA QUE EJECUTEN LA PRESENTACION, EL SISTEMA TAMBIEN SINCRONIZA EL VIDEO QUE SE PRESENTA, LOS ROBOTS TAMBIEN CUENTAN CON FUNCIINES COMO RECONOCIMIENTO DE ROSTROS Y SEGUIMIENTO Y RECONOCIMIENTO DE GESTOS.
